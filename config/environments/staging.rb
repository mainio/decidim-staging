...
Rails.application.configure do
  ...
  # Secure cookies only
  config.session_store :cookie_store, key: "_decidim-qastag_session", secure: true, httponly: true
  ...
  # config.active_job.queue_name_prefix = "decidim-qa8271decidimstag_#{Rails.env}"
